...
class SuspectedContactWind(tk.Frame):
    def __init__(self, master=None):
        ...
        self.add_suspected_contact_wind = Image.open(self.add_image_path)
        self.add_suspected_contact_wind = self.add_image.resize((900, 500), Image.NEAREST)
        self.add_suspected_contact_wind= ImageTk.PhotoImage(self.add_image)
