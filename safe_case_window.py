...
class SafeCaseWind(tk.Frame):
    def __init__(self, master=None):
        ...
        self.add_safe_case_wind_wind = Image.open(self.add_image_path)
        self.add_safe_case_wind_wind = self.add_image.resize((900, 500), Image.NEAREST)
        self.add_safe_case_wind_wind= ImageTk.PhotoImage(self.add_image)
